...
import { Zap, Rocket, ShieldCheck, Lock, ArrowLeft, CheckCircle2 } from "lucide-react";
  ...
  return (
    <>
      ...
      <div style={{
        ...
        {/* Green-tinted radial glow for sign up */}
        <div style={{
          position:"absolute", inset:0, pointerEvents:"none",
          background:"radial-gradient(ellipse 60% 50% at 50% 0%, rgba(5,150,105,0.06) 0%, transparent 70%)"
        }} />
        ...
        <main style={{
          ...
          >
            ...
            <div style={{ textAlign:"center" }}>
              ...
              >
                <span className="pill-badge"><Rocket size={11} /> Free forever · No card needed</span>
              </motion.div>
              <h1 style={{
              ...
              <p style={{ fontSize:16, color:"var(--text-2)", fontWeight:400 }}>
                Join 50,000+ teams automating their meetings.
              </p>
            </div>
            ...
            >
              {PERKS.map((p, i) => (
                <span key={i} style={{
                  ...
                  <CheckCircle2 size={11} color="#059669" /> {p}
                </span>
              ))}
            </motion.div>
            ...
            >
              ...
              <span style={{ width:1, height:12, background:"var(--border-2)" }} />
              <span className="trust-badge">
                <Zap size={13} color="#D97706" /> Cancel anytime
              </span>
            </motion.div>
          </motion.div>
        </main>
